        ...
        <div class="layui-tab layui-tab-card">
            ...
            <div class="layui-tab-content page-tab-content">
                <div class="layui-tab-item layui-show">
                    <form class="layui-form" action="<?php echo url('project/addmreport?proid='.$proid); ?>" method="post" id="editForm">
<div class="page-form">
	    ...
	    <div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	            <?php if($editpar == 1): ?>
	            	...
	            	<a href="<?php echo url('project/reexamlist?proid='.$proid); ?>"  class="layui-btn layui-btn-fluid ml10" style="width:30%;">下一步</a>
	            <?php else: ?>
