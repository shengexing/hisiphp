<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:91:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp/app/admin\view\project\problemlist.php";i:1537922679;s:78:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537877126;s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
    ...
    <form class="layui-form" action="<?php echo url(); ?>" method="post">
        <div id="searchBox" class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:450px;">
                <input type="checkbox" class="field-isresolve"  name="isresolve" <?php if(strcmp(1,$isresolve)): ?> checked <?php endif; ?> value=2 title="已解决问题">
                <input type="checkbox" class="field-isnotresolve"  name="isnotresolve" <?php if(strcmp(1,$isnotresolve)): ?> checked value=2 <?php endif; ?> title="未解决问题">
                <input type="checkbox" class="field-ismonth"  name="ismonth" <?php if(strcmp(1,$ismonth)): ?> checked <?php endif; ?> value=2 title="当月新增问题">
            </div>
...
<table class="layui-table mt10" lay-even="" lay-skin="row">
    ...
    <tr>
        ...
        <td><?php echo $v['qtype']; ?></td>
        <td><?php echo $v['notes']; ?></td>
        <td><?php echo $v['utime']; ?></td>
        <td><?php echo $v['exceptdate']; ?></td>
        <td><?php echo $v['consultdate']; ?></td>
...
<script>
    ...
    var aaa = <?php echo $isresolve; ?>;
    var bbb = <?php echo $isnotresolve; ?>;
    var ccc = <?php echo $ismonth; ?>;
