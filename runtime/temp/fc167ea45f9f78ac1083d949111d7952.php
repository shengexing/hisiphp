<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\phpStudy\WWW\hisiphp\hisiphp/app/admin\view\project\assets.php";i:1531729145;s:57:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\header.php";i:1535380276;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div id="searchBox" class="layui-form-item"> 
        <div class="layui-input-inline" style="width:750px;">
            <a <?php if($type == 1): ?>class="layui-btn layui-btn-normal"<?php else: ?>class="layui-btn layui-btn-primary"<?php endif; ?> href=<?php echo url('admin/project/assets?type=1'); ?>>十大产业项目</a>
            <a <?php if($type == 2): ?>class="layui-btn layui-btn-normal"<?php else: ?>class="layui-btn layui-btn-primary"<?php endif; ?> href=<?php echo url('admin/project/assets?type=2'); ?>>十大重点项目</a>
            <a <?php if($type == 3): ?>class="layui-btn layui-btn-normal"<?php else: ?>class="layui-btn layui-btn-primary"<?php endif; ?> href=<?php echo url('admin/project/assets?type=3'); ?>>责任单位</a>
            <a <?php if($type == 4): ?>class="layui-btn layui-btn-normal"<?php else: ?>class="layui-btn layui-btn-primary"<?php endif; ?> href=<?php echo url('admin/project/assets?type=4'); ?>>办事处</a>
        </div>
    </div>
