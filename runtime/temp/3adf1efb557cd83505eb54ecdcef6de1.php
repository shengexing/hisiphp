<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp/app/admin\view\index\index.php";i:1537862522;s:78:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537523598;s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
             ...
             <table class="layui-table mt10" lay-even="" lay-skin="row">
                <tbody>
                      <tr>
                       ...
                       <tr>
                          <td>营业执照：</td>
                          <td><?php echo $company['licence']; ?><a href="javascript:void(0);" data-src='<?php echo $company['licence_img']; ?>' style="color: #0000cc; float:right;" class="liucheng">查看详情</a></td>
                          <td>法人姓名：</td>
                          <td><?php echo $company['legal']; ?></td>
                      </tr>
                      <tr>
                          <td>企业简介：</td>
                          <td colspan="3"><?php echo $company['notes']; ?></td>
                      </tr>
                </tbody>
            </table>
         <?php else: ?>
            <blockquote class="layui-elem-quote">
              企业基本信息
              <a href="<?php echo url('admin/project/company'); ?>"  class="layui-btn layui-btn-big">完善企业信息</a>
            </blockquote>
         <?php endif; ?>
          ...
          <div class="layui-form">
              <table class="layui-table mt10" lay-even="" lay-skin="row">
                  ...
                  <tbody>
                      <?php if(is_array($project) || $project instanceof \think\Collection || $project instanceof \think\Paginator): $i = 0; $__LIST__ = $project;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                      <tr>
                          ...
                          <td>
                              <?php if($v['step'] >= 60): ?>
                                  <div class="layui-btn-group">
                                      <a  target="_blank" href="<?php echo url('admin/project/mreportlist?proid='.$v['recid']); ?>" class="layui-btn layui-btn-primary layui-btn-small">
                                          提交月报
                                      </a>
                                  </div>
                              <?php else: ?>
                          ...
                          <td>
                           ...
                           <td>
                              ...
                              <div class="layui-btn-group">
                                  <div class="layui-btn-group">
                                      <a target="_blank" href="<?php echo url('admin/project/generateditem?proid='.$v['recid']); ?>?type=examitem" class="layui-btn layui-btn-primary">
                                          完善信息
                                      </a>
                                  </div>
                              </div>
                              <?php endif; if($v['step'] >= 30): ?>
                              <div class="layui-btn-group">
                                  <div class="layui-btn-group">
                                      <a target="_blank" href="<?php echo url('admin/project/baseitem?proid='.$v['recid']); ?>?type=examitem" class="layui-btn layui-btn-primary">
                                          预览信息
                                      </a>
                                  </div>
                              </div>
...
<?php endif; if($roleid == 4): ?>

   <div class="glxtindex" id="glxtindex">
            <a href="<?php echo url('admin/project/examine?type=1'); ?>" class="loginfirst"></a>
            <a href="javascript:void(0)" class="loginforth" id="show_xzxmindex"></a>
            <a href="<?php echo url('admin/project/timelimit'); ?>" class="loginfirst"></a>
    </div>

    <div class="xzxmindex hide" id="xzxmindex">
        <div class="xzxmindex_right">
              <div class="rightfirst">
                  <a class="company" href="<?php echo url('admin/project/companyinfo'); ?>"></a>
                  <a class="shengshi" href="<?php echo url('admin/project/statis?type=1'); ?>"></a>
                  <a class="shuangshi" href="<?php echo url('admin/project/tens'); ?>"></a>
                  <a class="guding" href="<?php echo url('admin/project/assets'); ?>"></a>
                  <a class="zonglan" href="<?php echo url('admin/project/statis'); ?>"></a>
              </div>
              <div class="rightsenc">
                  <a class="fenguan" href="<?php echo url('admin/project/fenguan'); ?>"></a>
                  <a class="shouxu" href="<?php echo url('admin/project/shouxu'); ?>"></a>
                  <a class="xiequ" class="shengshi" href="<?php echo url('admin/project/xiaqu'); ?>"></a>
              </div>
        </div>
    </div>
<?php endif; if($roleid == 5): ?>
<div class="xzxmindex">
    <div class="xzxmindex_right">
          <div class="rightfirst">
              <a class="daishenhe" href="<?php echo url('admin/prouser/listuser?type=1'); ?>"></a>
              <a class="zonglan" href="<?php echo url('admin/prouser/listuser?type=11'); ?>"></a>
              <a class="zonglan" href="<?php echo url('admin/project/problemlist?type=7'); ?>"></a>
          </div>
    </div>
</div>
<?php endif; if($roleid == 6): ?>
<div class="xzxmindex">
    <div class="xzxmindex_right">
          <div class="rightsenc">
              <?php if($stype == 2): ?>
              <a class="shouxu" href="<?php echo url('admin/project/statis?type=5'); ?>"></a>
              <a class="shouxu" href="<?php echo url('admin/project/problemlist?type=7'); ?>"></a>
              <?php endif; if($stype == 3): ?>
              <a class="xiequ" class="shengshi" href="<?php echo url('admin/project/statis?type=6'); ?>"></a>
              <?php endif; ?>
          </div>
    </div>
</div>
