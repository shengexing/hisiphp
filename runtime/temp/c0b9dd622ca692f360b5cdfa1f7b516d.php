<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:88:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp/app/admin\view\project\dynalist.php";i:1531729145;s:78:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537523598;s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
        ...
        <div class="layui-tab layui-tab-card">
            ...
            <div class="layui-tab-content page-tab-content">
                <div class="layui-tab-item layui-show">
                    <div <?php if($leftmenu > 0): ?> class="page-toolbar page-form" <?php else: ?>class="page-toolbar"<?php endif; ?>>
    <?php if($editAcc == 1): ?>
        <div class="layui-btn-group fl">
            <a href="<?php echo url('admin/project/dynamic?proid='.$proid); ?>" class="layui-btn layui-btn-primary"><i class="aicon ai-tianjia"></i>发布项目问题</a>
        </div>
    <?php endif; ?>
</div>

<fieldset <?php if($leftmenu > 0): ?>class="layui-elem-field layui-field-title page-form"<?php else: ?>class="layui-elem-field layui-field-title"<?php endif; ?> style="margin-top: 30px;">
  <legend>项目问题</legend>
</fieldset>
<ul <?php if($leftmenu > 0): ?> class="layui-timeline page-form" <?php else: ?> class="layui-timeline" <?php endif; ?>>
    <?php if(is_array($dynamic) || $dynamic instanceof \think\Collection || $dynamic instanceof \think\Paginator): $dk = 0; $__LIST__ = $dynamic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dv): $mod = ($dk % 2 );++$dk;?>
          <li class="layui-timeline-item">
            <i class="layui-icon layui-timeline-axis"></i>
            <div class="layui-timeline-content layui-text">
                <h3 class="layui-timeline-title">
                    <span class="fl">
                        <?php echo $dynamicType[$dv['qtype']]; if($dv['qtype'] == 1): ?>
                            <a href="<?php echo url('admin/project/dynamic?proid='.$proid.'&recid='.$dv['recid']); ?>">
                                <?php if($dv['etype'] > 0): ?>
                                    (<?php echo $xianchang[$dv['etype']]['title']; ?>)                            
                                <?php endif; ?>

                            </a>
                        <?php elseif($dv['qtype'] == 2): ?>
                            <a href="<?php echo url('admin/project/dynamic?proid='.$proid.'&recid='.$dv['recid']); ?>">
                                <?php if($dv['etype'] > 0): ?>
                                    (<?php echo $examName[$dv['etype']]['title']; ?>)                            
                                <?php endif; ?> 
                            </a>
                        <?php else: endif; if($dv['status'] == 0): ?>
                            <b class="green">已处理</b>
                        <?php else: ?>
                            <b class="red">未处理</b>
                        <?php endif; ?>
                    </span>
                     <p class="fl"><?php echo $dv['notes']; ?><p>
                     <p class="fr"><?php echo $dv['ctime']; ?></p>
                </h3>
            </div>
          </li>
    <?php endforeach; endif; else: echo "" ;endif; ?>
