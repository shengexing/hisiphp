<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:88:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp/app/admin\view\project\baseitem.php";i:1537508665;s:78:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537368268;s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
            ...
            <tbody>
                <tr class="baseitem">
                    ...
                    <td colspan="3">
                        ...
                        <?php if($info['step'] < 40): ?>
                            <span class="red">(等待企业提交)</span>
                        <?php elseif($info['step'] < 50): ?>
                            <span class="red">(等待主管部门提交)</span>
                        <?php elseif($info['step'] == 50): ?>
                            <span class="red">(待审核)</span>
                        <?php else: ?>
                            <span class="green">(已审核)</span>
                        <?php endif; if($editpar == 1): ?>
                            <a target="_blank" href="<?php echo url('project/generateditem?proid='.$info['recid']); ?>" 
                             class="layui-btn  layui-btn-fluid ml10" id="exam_edit" style="width:15%;">
                                修改项目信息
                            </a>
                        <?php endif; if($subexam == 1): ?>
                ...
                <tr  class="layui-table-hover baseitem">
                    ...
                    <td>
                        <?php if($info['dunit'] > 0): ?>
                        <?php echo $examUnit[$info['dunit']]['title']; endif; ?>
                ...
                <tr  class="layui-table-hover baseitem">
                    ...
                    <td><?php if($info['isten'] == 1): if($info['tentype'] > 0): ?>
                ...
                <tr  class="layui-table-hover builditem">
                    <td>主要建设内容</td>
                    <td colspan="3"><?php echo $notes['significance']; ?></td>
                </tr>

                <tr class="builditem">
                    <td>效益效值</td>
                    <td colspan="3"><?php echo $notes['effect']; ?></td>
                </tr>
                ...
                <tr class="layui-table-hover builditem">
                        ...
                        <td colspan="3">
                            <?php if($capitalCnt > 0): if(is_array($capital) || $capital instanceof \think\Collection || $capital instanceof \think\Paginator): $pk = 0; $__LIST__ = $capital;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($pk % 2 );++$pk;?>
                                    <?php echo $capitalType[$pt['ctype']]['title']; ?>：<?php echo $pt['amount']; ?></br>
                ...
                <?php if(is_array($examName) || $examName instanceof \think\Collection || $examName instanceof \think\Paginator): $ek = 0; $__LIST__ = $examName;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$et): $mod = ($ek % 2 );++$ek;if($examShow[$et['recid']]['cnt'] > 0): ?>
                        <tr <?php if($ek%2 == 1): ?> class="layui-table-hover examitem" <?php else: ?>  class="examitem" <?php endif; ?>>
                            <!-- <td rowspan="<?php echo $examShow[$ek]['cnt']+1; ?>"><?php echo $et['title']; ?></td> -->
                            <td><?php echo $et['title']; ?></td>
                            <?php if(is_array($examShow[$et['recid']]['data']) || $examShow[$et['recid']]['data'] instanceof \think\Collection || $examShow[$et['recid']]['data'] instanceof \think\Paginator): $sk = 0; $__LIST__ = $examShow[$et['recid']]['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$st): $mod = ($sk % 2 );++$sk;if($st['status'] == 1): ?>
                                    <td><span class="red">未提交</span></td>
                                    <td colspan="2">原因：<?php echo $st['notes']; ?></td>
                                <?php elseif($st['status'] == 2): ?>
                                    <td><span>进行中</span></td>
                                    <td colspan="2">办理进程：<?php echo $st['notes']; ?></td>
                                <?php elseif($st['status'] == 3): ?>
                                    <td><span class="green">已完成</span></td>
                                    <td>许可证号：<?php echo $st['permit']; ?>
...
<script>
var suburl = "<?php echo url('project/subexam?proid='.$info['recid']); ?>";
