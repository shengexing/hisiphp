<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:87:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp/app/admin\view\project\dynamic.php";i:1537848196;s:78:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537523598;s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
        ...
        <div class="layui-input-inline"  style="width:850px">
            <?php if(is_array($examUnit) || $examUnit instanceof \think\Collection || $examUnit instanceof \think\Paginator): $pk = 0; $__LIST__ = $examUnit;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($pk % 2 );++$pk;?>
                <input type="checkbox" value="<?php echo $pt['recid']; ?>"
                    ...
                    <?php if($pt['checked'] == 1): ?>checked<?php endif; ?> title="<?php echo $pt['title']; ?>"
                     name="qespunit[]">
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
