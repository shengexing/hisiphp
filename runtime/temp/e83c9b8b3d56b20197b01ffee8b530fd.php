<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:66:"D:\phpStudy\WWW\hisiphp\hisiphp/app/admin\view\project\fenguan.php";i:1535982841;s:57:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537084664;s:62:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
    ...
    <div class="xzxmindex">
        <div class="xzxmindex_right">
              <div class="rightthird">
                    <?php if(is_array($fenguan) || $fenguan instanceof \think\Collection || $fenguan instanceof \think\Paginator): $i = 0; $__LIST__ = $fenguan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <a href="<?php echo url('admin/project/statis?type=4&punit='.$v['dunit']); ?>">
                            <?php if($v['dunit'] > 0): ?><?php echo $examUnit[$v['dunit']]['title']; endif; ?>
                            (<?php if($v['cnt'] > 0): ?><?php echo $v['cnt']; else: ?>0<?php endif; ?>)
                        </a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
              </div>
        </div>
            ...
            <tr>
                ...
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            <a target="_blank" href="<?php echo url('admin/project/statis?type=4&punit='.$v['dunit']); ?>" class="layui-btn layui-btn-primary">
                                查看详情
                            </a>
                        </div>
                    </div>
