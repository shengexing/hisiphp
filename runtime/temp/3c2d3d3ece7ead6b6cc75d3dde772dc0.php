<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp/app/admin\view\dict\detail.php";i:1531729143;s:78:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537523598;s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
...
<div class="page-toolbar">
    <div class="layui-btn-group fl">
        <a href="<?php echo url('admin/dict/add?dict='.$dict); ?>" class="layui-btn layui-btn-primary"><i class="aicon ai-tianjia"></i>添加附表信息</a>
    </div>
</div>
    ...
    <table class="layui-table mt10" lay-even="" lay-skin="row">
        ...
        <tbody>
            ...
            <tr>
                ...
                <?php if($type == 2): ?>
                    <td><?php echo $pdata[$v['pid']]['title']; ?></td>
                <?php endif; ?>
                ...
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            <a href="<?php echo url('dict/edit?dict='.$dict.'&recid='.$v['recid']); ?>" class="layui-btn layui-btn-primary layui-btn-small">修改信息</a>
                        </div>
                    </div>
                </td>
            </tr>
