<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:67:"D:\phpStudy\WWW\hisiphp\hisiphp/app/admin\view\project\editexam.php";i:1535378784;s:57:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\header.php";i:1535380276;s:62:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
        ...
        <div class="layui-header" style="z-index:999!important;">
            ...
            <ul class="layui-nav fl nobg main-nav">
                ...
                <?php elseif($roleid == 5): ?>
                    ...
                    <li class="layui-nav-item"><a href=<?php echo url('admin/prouser/adduser'); ?>>
                        <span class="nav_first">添加用户</span></a>
                    </li>
                    <li class="layui-nav-item">
                        <a href="javascript:void(0);" id="lockScreen"><span class="nav_clock">锁屏</span></a>
                    </li>
...
<div class="page-form">
    <div class="layui-form-item" id="exam_name">
        ...
        <div class="layui-input-inline">
            <input readonly type="text" class="layui-input layui-noborder" value=<?php echo $examName; ?>>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <?php if($examData['status'] == 1): ?><input readonly type="text" class="layui-input layui-noborder" value='未提交'><?php endif; if($examData['status'] == 2): ?><input readonly type="text" class="layui-input layui-noborder" value='进行中'><?php endif; if($examData['status'] == 3): ?><input readonly type="text" class="layui-input layui-noborder" value='已完成'><?php endif; ?>

             <input type="hidden" name="status" value="<?php echo $examData['status']; ?>">
        </div>
    </div>

    <div class="layui-form-item"  id="qespunit_box">
        <label class="layui-form-label layui-form-project">涉及单位：</label>
        <div class="layui-input-inline" style="width:750px">
            <?php if(is_array($unitData) || $unitData instanceof \think\Collection || $unitData instanceof \think\Paginator): $pk = 0; $__LIST__ = $unitData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($pk % 2 );++$pk;?>
                <input type="checkbox" value="<?php echo $pt['recid']; ?>" 
                    class="layui-input field-capital capital-checkbox" <?php if($examUnit[$pt['recid']]['check'] == 1): ?>checked<?php endif; ?> name="qespunit[]"><?php echo $pt['title']; endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
    ...
    <div class="layui-form-item hide" id="punit_box">
        ...
        <div class="layui-input-inline">
             <select name="punit" type="select" class="field-punit" lay-filter="punit">
                <option value="">请选择...</option>
                <?php if(is_array($lastexam) || $lastexam instanceof \think\Collection || $lastexam instanceof \think\Paginator): $pk = 0; $__LIST__ = $lastexam;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($pk % 2 );++$pk;?>
    ...
    <div class="layui-form-item hide"  id="permit_box">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-permit" name="permit" autocomplete="off" placeholder="许可证号（必填）">
        </div>
    </div>
    ...
    <div class="layui-form-item hide" id="img_box">
        ...
        <div class="layui-input-inline upload">
            ...
            <input type="hidden" class="upload-input field-img" name="img" class="field-img" value="">
            <img src="" id="imgshow_box" class="field-img"  style="display:none;border-radius:5px;border:1px solid #ccc"  height="220">
        </div>   
    </div>
    ...
    <div class="layui-form-item hide" id="notes_box">
        ...
        <div class="layui-input-block">
            <textarea rows="3"  class="layui-textarea field-notes" name="notes" autocomplete="off" placeholder=""></textarea>
        </div>
    </div>    
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="hidden" class="field-id" name="recid" value = <?php echo $recid; ?>>
            <input type="hidden" class="field-id" name="proid" value = <?php echo $proid; ?>>
           
            <?php if($editdata == 1): ?>
                <button type="submit" lay-submit="" style="width:30%;" class="layui-btn layui-btn-fluid" lay-filter="formSubmit">修改审批信息</button>
            <?php endif; if($step >= 60): ?>
            <a href="<?php echo url('project/reexamlist?proid='.$proid); ?>"  style="width:30%;" class="layui-btn layui-btn-primary layui-btn-fluid ml10"><i class="aicon ai-fanhui"></i>返回</a>
            <?php else: ?>
            <a href="<?php echo url('project/examlist?proid='.$proid); ?>"  style="width:30%;" class="layui-btn layui-btn-primary layui-btn-fluid ml10"><i class="aicon ai-fanhui"></i>返回</a>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<script>
var formData = <?php echo json_encode($examData); ?>;
layui.use(['jquery', 'laydate', 'upload', 'form'], function() {
    ...
    if(formData.img) {
        $("#imgshow_box").attr('src', formData.img).show();
    }
