<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:90:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp/app/admin\view\project\reexamlist.php";i:1531729146;s:78:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537523598;s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="finish_box hide">
                                            <a href="<?php echo url('admin/project/addexam?proid='.$proid.'&ptype='.$pt['recid'].'&type=3'); ?>" class="layui-btn layui-btn-primary">
                                                <i class="aicon ai-tianjia"></i>添加审批
                                            </a>
                                        </div>
                                        <div class="unfinish_box hide">
                                            <a href="<?php echo url('admin/project/addexam?proid='.$proid.'&ptype='.$pt['recid'].'&type=1'); ?>" class="layui-btn layui-btn-primary">
                                                <i class="aicon ai-tianjia"></i>添加原因
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                </td>
                            <?php endif; if($pt['cnt'] == 0): ?>
                                <td>暂未提交信息</td>  
                            <?php else: if(isset($examData[$pt['recid']])): if(is_array($examData[$pt['recid']]) || $examData[$pt['recid']] instanceof \think\Collection || $examData[$pt['recid']] instanceof \think\Paginator): $ek = 0; $__LIST__ = $examData[$pt['recid']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$et): $mod = ($ek % 2 );++$ek;?>
                                        <td>
                                            <?php if($et['status'] == 3): ?>
                                                <span class="green"><?php echo $examStatus[$et['status']]; ?></span>
                                                许可证号：<?php echo $et['permit']; else: ?>
                                                <span class="red"><?php echo $examStatus[$et['status']]; ?></span>
                                            <?php endif; ?>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="<?php echo url('admin/project/editexam?recid='.$et['recid']); ?>" class="layui-btn layui-btn-primary">
                                                <i class="aicon ai-tianjia"></i>查看详情
                                            </a>
                                        </td>
                                    <?php endforeach; endif; else: echo "" ;endif; endif; endif; ?>
                            <td>
                                <a href="javascript:void(0);" data-src='<?php echo $pt['img']; ?>' class="liucheng">查看流程</a>
                            </td>
                        </tr>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <a href="<?php echo url('project/progress?proid='.$proid); ?>"  class="layui-btn layui-btn-fluid ml10" style="width:30%;">下一步</a>
        </div>
    </div>
</div>
