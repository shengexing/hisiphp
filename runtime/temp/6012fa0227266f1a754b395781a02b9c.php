<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp/app/admin\view\user\userform.php";i:1531729146;s:78:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537519248;s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
...
<div class="layui-tab-item layui-show layui-form-pane">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="unit" class="field-unit" type="select">
                ...
                <?php if(is_array($unitData) || $unitData instanceof \think\Collection || $unitData instanceof \think\Paginator): $pk = 0; $__LIST__ = $unitData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($pk % 2 );++$pk;if($pt['status'] == 1): ?>
                        <option value="<?php echo $pk; ?>"><?php echo $pt['title']; ?></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="xiaqu" class="field-xiaqu" type="select">
                <option value="0">请选择...</option>
                <?php if(is_array($xiaquData) || $xiaquData instanceof \think\Collection || $xiaquData instanceof \think\Paginator): $pk = 0; $__LIST__ = $xiaquData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($pk % 2 );++$pk;?>
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="stype" class="field-stype" type="select">
                <option value="0">请选择...</option>
                <?php if(is_array($stypeArr) || $stypeArr instanceof \think\Collection || $stypeArr instanceof \think\Paginator): $pk = 0; $__LIST__ = $stypeArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($pk % 2 );++$pk;?>
                        <option value="<?php echo $pt['recid']; ?>"><?php echo $pt['title']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
   ...
   <!--  <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="department" class="field-department" type="select">
                <option value="">请选择...</option>
                <?php if(is_array($departmentData) || $departmentData instanceof \think\Collection || $departmentData instanceof \think\Paginator): $pk = 0; $__LIST__ = $departmentData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($pk % 2 );++$pk;if($pt['status'] == 1): ?>
                        <option value="<?php echo $pk; ?>"><?php echo $pt['title']; ?></option>
                    <?php endif; endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="upost" value={} class="field-upost" type="select">
                <option value="">请选择...</option>
                <?php if(is_array($upostData) || $upostData instanceof \think\Collection || $upostData instanceof \think\Paginator): $pk = 0; $__LIST__ = $upostData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($pk % 2 );++$pk;if($pt['status'] == 1): ?>
                        <option value="<?php echo $pk; ?>"><?php echo $pt['title']; ?></option>
                    <?php endif; endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
