<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:88:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp/app/admin\view\prouser\listuser.php";i:1537517368;s:78:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537523598;s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div <?php if($leftmenu == 0): ?> class="layui-form"  <?php else: ?>class="layui-form page-form-width"<?php endif; ?>>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if($v['step'] < 40): ?>
                            <span>等待企业提交审核</span>
                        <?php elseif($v['step'] == 40): ?>
                            <span class="red">待审核</span>
                        <?php elseif($v['step'] == 50): ?>
                    ...
                    <td>
                        <?php if($v['step'] == 40): ?>
                            <a target="_blank" href="<?php echo url('project/baseitem?proid='.$v['proid']); ?>" class="layui-btn layui-btn-primary layui-btn-small red">待审核</a>
                        <?php endif; if($v['step'] > 40 and $v['step'] < 60): ?>
                            <a  target="_blank" href="<?php echo url('admin/project/baseitem?proid='.$v['proid']); ?>" class="layui-btn layui-btn-primary layui-btn-small">
                                预览申报信息
                            </a>
                        <?php endif; if($v['step'] == 60): ?>
                            <a  target="_blank" href="<?php echo url('admin/project/mreport?proid='.$v['proid']); ?>" class="layui-btn layui-btn-primary layui-btn-small">
                                查看详情
                            </a>
                        <?php endif; ?>
                    </td>
