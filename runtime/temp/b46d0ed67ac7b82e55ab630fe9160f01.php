<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:64:"D:\phpStudy\WWW\hisiphp\hisiphp/app/admin\view\project\xiaqu.php";i:1531729145;s:57:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\header.php";i:1535380276;s:62:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="xzxmindex">
        <div class="xzxmindex_right">
              <div class="rightthird">
                    <?php if(is_array($Dictxiaqu) || $Dictxiaqu instanceof \think\Collection || $Dictxiaqu instanceof \think\Paginator): $i = 0; $__LIST__ = $Dictxiaqu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <a href="<?php echo url('admin/project/statis?type=6&xq='.$v['recid']); ?>">
                            <?php echo $v['title']; ?>
                            (<?php if(isset($xiaqu[$v['recid']])): ?><?php echo $xiaqu[$v['recid']]['cnt']; else: ?>0<?php endif; ?>)
                        </a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
              </div>
        </div>
    ...
    <table class="layui-table mt10 hide" id="detail_box" lay-even="" lay-skin="row">
        ...
        <tbody>
            <?php if(is_array($xiaqu) || $xiaqu instanceof \think\Collection || $xiaqu instanceof \think\Paginator): $i = 0; $__LIST__ = $xiaqu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
            <tr>
                <td><?php echo $Dictxiaqu[$v['xiaqu']]['title']; ?></td>
                ...
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            <a target="_blank" href="<?php echo url('admin/project/statis?type=6&xq='.$v['xiaqu']); ?>" class="layui-btn layui-btn-primary">
                                查看详情
                            </a>
                        </div>
                    </div>
