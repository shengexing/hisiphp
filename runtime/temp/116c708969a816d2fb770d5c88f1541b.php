...
<div class="page-form">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <textarea rows="5"  class="layui-textarea field-effect" name="progress" autocomplete="off" placeholder="必填"><?php echo $progress['progress']; ?></textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <?php if($editpar == 1): ?>
                ...
                <a href="<?php echo url('project/dynalist?proid='.$proid); ?>"  class="layui-btn layui-btn-fluid ml10" style="width:30%;">下一步</a>
            <?php else: ?>
