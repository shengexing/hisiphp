<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:60:"D:\phpStudy\WWW\hisiphp\hisiphp/app/admin\view\dict\edit.php";i:1531729142;s:57:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537084664;s:62:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
...
<div class="page-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="pid" type="select" lay-verify="required">
                    ...
                    <?php if(is_array($pdata) || $pdata instanceof \think\Collection || $pdata instanceof \think\Paginator): $pk = 0; $__LIST__ = $pdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($pk % 2 );++$pk;if($pt['status'] == 1): ?>
                        <option value="<?php echo $pk; ?>" <?php if($data['pid'] == $pk): ?> selected <?php endif; ?>><?php echo $pt['title']; ?></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" value="<?php echo $data['title']; ?>" name="title" lay-verify="required" autocomplete="off" placeholder="名称（必填）">
        </div>
    </div>

   <?php if($type == 3 or $type == 4 or $type == 6): ?>
    ...
    <?php endif; if($type == 4): ?>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="radio" class="field-type" name="type" value="1" title="重大产业项目" <?php if($data['type'] == 1): ?>checked<?php endif; ?>>
                <input type="radio" class="field-type" name="type" value="2" title="十类重点工程" <?php if($data['type'] == 2): ?>checked<?php endif; ?>>
            </div>
        </div>
         ...
         <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea id="ckeditor" name="content"><?php echo $data['content']; ?></textarea>
            </div>
        </div>
    <?php endif; if($type == 5 or $type == 6): ?>
         <div class="layui-form-item">
        <label class="layui-form-label layui-form-project">排序：</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-sorder" value="<?php echo $data['sorder']; ?>" name="sorder" lay-verify="required" autocomplete="off" placeholder="排序">
        </div>
    </div>
    <?php endif; ?>
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="radio" class="field-status" name="status" value="1" title="启用" <?php if($data['status'] == 1): ?>checked<?php endif; ?>>
            <input type="radio" class="field-status" name="status" value="0" title="禁用" <?php if($data['status'] == 0): ?>checked<?php endif; ?>>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="hidden" class="field-id" name="dict" value = <?php echo $dict; ?>>
            <input type="hidden" class="field-id" name="recid" value = <?php echo $recid; ?>>
            <button type="submit" class="layui-btn" lay-submit="" lay-filter="formSubmit">提交</button>
            <a href="<?php echo url('dict/detail?dict='.$dict); ?>" class="layui-btn layui-btn-primary ml10"><i class="aicon ai-fanhui"></i>返回</a>
        </div>
    </div>
</div>
</form>
...
<?php if($type == 4): ?>
<?php echo editor(['ckeditor'], 'ckeditor'); endif; ?>
<script>
