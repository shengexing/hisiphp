<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:82:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp/app/admin\view\dict\index.php";i:1531729142;s:78:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537523598;s:83:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:84:"D:\1.Develop_Tool\7.xampp7.29\htdocs\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <table class="layui-table mt10" lay-even="" lay-skin="row">
        ...
        <tbody>
            <?php if(is_array($dicttable) || $dicttable instanceof \think\Collection || $dicttable instanceof \think\Paginator): $k = 0; $__LIST__ = $dicttable;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>
            <tr>
                <td><?php echo $v['title']; ?></td>
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            <a href="<?php echo url('dict/detail?dict='.$k); ?>" class="layui-btn layui-btn-primary layui-btn-small">查看附表信息</a>
                        </div>
                    </div>
                </td>
            </tr>
