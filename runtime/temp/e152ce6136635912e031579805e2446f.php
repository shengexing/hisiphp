<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:66:"D:\phpStudy\WWW\hisiphp\hisiphp/app/admin\view\project\addexam.php";i:1535378560;s:57:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\layout.php";i:1531729143;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\header.php";i:1537084664;s:62:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\layui.php";i:1531729143;s:63:"D:\phpStudy\WWW\hisiphp\hisiphp\app\admin\view\block\footer.php";i:1531729143;}*/ ?>
...
<div class="page-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" id="status_box">
            <?php if($type == 1): ?><input readonly type="text" class="layui-input layui-noborder" value='未提交'><?php endif; if($type == 2): ?><input readonly type="text" class="layui-input layui-noborder" value='进行中'><?php endif; if($type == 3): ?><input readonly type="text" class="layui-input layui-noborder" value='已完成'><?php endif; ?>
        ...
        <div class="layui-input-inline" style="width:750px">
            <?php if(is_array($unitData) || $unitData instanceof \think\Collection || $unitData instanceof \think\Paginator): $pk = 0; $__LIST__ = $unitData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($pk % 2 );++$pk;?>
                <input type="checkbox" value="<?php echo $pt['recid']; ?>" 
                    class="layui-input field-capital capital-checkbox" name="qespunit[]"><?php echo $pt['title']; endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="hidden" class="field-id" name="ptype" value = <?php echo $ptype; ?>>
