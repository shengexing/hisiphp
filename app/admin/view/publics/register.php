...
<div class="login-box">
    <div class="layui-form layui-form-pane">
        ...
        <a href="{:url('publics/index')}"class="layui-field-back">返回登陆</a>
        ...
        <div class="copyright">
        <p>© 2017-2018 <a href="{:config('hisiphp.url')}" target="_blank">经开区项目管理</a> All Rights Reserved.</p>
                    ...
                    if ( data.code == 0 ) {
                        layer.confirm(data.msg, {
                          btn: ['立即登录','取消'] //按钮
                            ...
                            location.href = '{:url("publics/index")}'
                        }, function(){
                            layer.closeAll();
                        });  
                    } else {
